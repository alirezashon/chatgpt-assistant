...
export const STORAGE_KEYS = {
  ...
  appLocale: `${EXTENSION_ID_PREFIX}:app-locale`,
  chats: `${EXTENSION_ID_PREFIX}:chats`,
  commandFavorites: `${EXTENSION_ID_PREFIX}:command-favorites`,
  commandHistory: `${EXTENSION_ID_PREFIX}:command-history`,
  ...
  languagePacks: `${EXTENSION_ID_PREFIX}:language-packs`,
  ...
  sidebarWorkspace: `${EXTENSION_ID_PREFIX}:sidebar-workspace`,
